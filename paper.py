...
def main():
    """
    Fetch paper metadata from DOI and write to papers.yml
    """
    # Parser
    parser = argparse.ArgumentParser(description="Fetch paper metadata from DOI")
    ...
    fetch = PubMedFetcher()
    article = fetch.article_by_doi(args.doi)
